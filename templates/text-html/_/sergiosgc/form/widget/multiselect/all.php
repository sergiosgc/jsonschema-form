<?php
$properties = [ 'name' => $tvars['propertyName'] . '[]', 'size' => 10, 'multiple' => true ];
foreach([
    'ui:class' => 'class',
    'ui:size' => 'size',
...
if (isset($tvars['property']['value'])) foreach($tvars['property']['options'] as $idx => $option) $tvars['property']['options'][$idx]['selected'] = in_array($option['value'], $tvars['property']['value']);
