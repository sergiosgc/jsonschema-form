...
if (1 == count($_REQUEST['property']['options']) && $_REQUEST['property']['ui:selectfirstonsinglevalue']) $_REQUEST['property']['options'][0]['selected'] = true;
    ...
    // Template components
?><?php if (1 == count($_REQUEST['property']['options']) && $_REQUEST['property']['ui:hideonsinglevalue']) { ?><input type="hidden" name="<?= strtr(@$_REQUEST['name'], [ '&' => '&amp;', '"' => '&quot;' ]) ?>" value="<?= strtr(@$_REQUEST['property']['options'][0]['value'], [ '&' => '&amp;', '"' => '&quot;' ]) ?>"<?php ob_start();
